	...
	<div id="content">
		...
		if (isset($_GET['cod'])) {
			if ($_GET['cod']==1) {
				...
				<input type="text" name="diretor" value="'.$dados[1].'" />				
				<label for="">* Ano</label>
				<input type="text" name="ano" value="'; if ($dados[2] != 0) { echo $dados[2]; } echo '" class="input_mini" />
				...
				<input type="text" name="especificacoes" value="'.$dados[3].'" class="nao-obrigatorio" />
				<label for="">Preço (R$)</label>
				<input type="text" name="preco" value="'.$dados[4].'" class="input_mini nao-obrigatorio" />
